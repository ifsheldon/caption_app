...
//
//public class ServiceClientOld extends Thread implements IServerClient {
...
//
//    public ServiceClientOld(ArrayAdapter<String> arrayAdapter) {
...
//        return stompClient.connect(url, headers, new MyHandler(), SERVER_ADDR, PORT);
//    }
//
//    private void subscribeToTopic(StompSession stompSession) throws ExecutionException, InterruptedException {
...
//        try {
//            this.subscribeToTopic(stompSession);
